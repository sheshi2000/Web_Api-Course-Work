            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <img className="w-44 h-auto" src="/logo.png" alt="" />

                        <p className="text-base leading-relaxed text-gray-600 mt-7">An efficient platform for reserving bus tickets online, providing seamless booking options, route details, and real-time availability updates.</p>
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            ...
                            <li>
                                <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Bookings </a>
                            </li>
                            ...
                            <li>
                                <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Login </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            ...
                            <li>
                                <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Biiking Details </a>
                            </li>
