  ...
  >
    <div className="relative flex flex-col bg-white shadow-lg rounded-xl w-full max-w-lg m-3 sm:mx-auto">
      ...
      <div className="p-6 sm:p-10 text-center">
        ...
        <span className="mb-4 inline-flex justify-center items-center size-[62px] rounded-full border-4 border-red-50 bg-red-100 text-red-500 dark:bg-yellow-700 dark:border-yellow-600 dark:text-yellow-100">
